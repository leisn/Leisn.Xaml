...
namespace System.Windows
{
    public static class RectEx
    {
        ...
        public static ref Rect Set(ref this Rect self, Point location) => ref self.Set(location.X, location.Y);
        public static ref Rect Set(ref this Rect self, Size size) => ref self.Set(Width: size.Width, Height: size.Height);
        ...
        public static Rect With(this Rect self, double? Left = null, double? Top = null, double? Width = null, double? Height = null)
            => new(Left ?? self.Left, Top ?? self.Top, Width ?? self.Width, Height ?? self.Height);
        public static Rect With(this Rect self, Point location) => self.With(location.X, location.Y);
        public static Rect With(this Rect self, Size size) => self.With(Width: size.Width, Height: size.Height);
        public static Rect WithBounds(this Rect self, double? Left = null, double? Top = null, double? Right = null, double? Bottom = null)
            => new(Left ?? self.X, Top ?? self.Y, Right == null ? self.Width : Right.Value - self.X, Bottom == null ? self.Height : Bottom.Value - self.Y);
        public static Rect WithBounds(this Rect self, Point rightBottom) => new(self.X, self.Y, rightBottom.X - self.X, rightBottom.Y - self.Y);
